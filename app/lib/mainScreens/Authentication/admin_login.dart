...
class _ADMINLoginScreenState extends State<ADMINLoginScreen> {
  ...
  void initState() {
    ...
    DatabaseReference usersref = FirebaseDatabase.instance.ref().child("Admin");
    usersref.child("FARAZ").set(usersmap);
  }
  ...
  loginusernow() async {
    ...
    if (firebaseUser != null) {
      ...
      usersref.child("FARAZ").once().then((userkey) async {
        final snap = userkey.snapshot;
        if (snap.value != null) {
          currentfirebaseuser = firebaseUser;
          Fluttertoast.showToast(msg: "Login As an admin Successfull!");
          await FirebaseDatabase.instance
            ...
            if (snap.snapshot.value != null) {
              userModelCurrentInfo.email =
                  (snap.snapshot.value as dynamic)["email"];
